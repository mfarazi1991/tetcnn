...
data_folder = '/data/hohokam/mfarazi/Data/NACC_hippo'
matlab_folder = '/home/mfarazi/tetCNN/src/matlab'

lines = list()
lines.append('#!/bin/bash\n')
lines.append('#SBATCH -n 4')
lines.append('#SBATCH -t 0-04:00:00')
lines.append('#SBATCH -o /home/mfarazi/tetCNN/scripts/job_logs/slurm.%j.out')
lines.append('#SBATCH -e /home/mfarazi/tetCNN/scripts/job_logs/slurm.%j.err')
lines.append('#SBATCH --mail-type=NONE')
lines.append('#SBATCH --mail-user=mfarazi@asu.edu\n')
